...
export UBUNTU_IMAGE_TAG=${UBUNTU_IMAGE_TAG:-${TF_DOCKER_BUILD_VERSION}-avx512-ubuntu}
export DEBIAN_IMAGE_TAG=${DEBIAN_IMAGE_TAG:-${TF_DOCKER_BUILD_VERSION}-avx512-debian}
export CENTOS_IMAGE_TAG=${CENTOS_IMAGE_TAG:-${TF_DOCKER_BUILD_VERSION}-avx512-centos}
...
cp -rp ${TENSORFLOW_WHLS}/${TF_DOCKER_BUILD_DEVEL_BRANCH}/python${PY_VERSION} ${TENSORFLOW_WHLS_TEMP}
